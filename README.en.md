...
> [!NOTE]
> The current version is a **0.5.0 Apple silicon preview**. An unsigned DMG is available from
> [GitHub Releases](https://github.com/dreamyoungs/solnari/releases/tag/v0.5.0). Until the project
...
- [Ephemeral Codex SQL assistant](docs/codex-privacy.md) with explicit context sharing and SQL review
...
Download `Solnari-0.5.0-macos-arm64-unsigned.dmg` from the
[Solnari 0.5.0 Release](https://github.com/dreamyoungs/solnari/releases/tag/v0.5.0). This free,
...
The output is `.build/release/Solnari-0.5.0-macos-arm64-unsigned.dmg` with a SHA-256 file. Like the
...
The output is `.build/release/Solnari-0.5.0-macos-arm64.dmg` with a SHA-256 file. The workflow signs
