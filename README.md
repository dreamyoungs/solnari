...
> [!NOTE]
> 현재 버전은 **0.5.2 Apple Silicon preview**입니다. [GitHub Releases에서 unsigned DMG를
> 받을 수 있습니다](https://github.com/dreamyoungs/solnari/releases/tag/v0.5.2). Apple
...
[Solnari 0.5.2 Release](https://github.com/dreamyoungs/solnari/releases/tag/v0.5.2)에서
`Solnari-0.5.2-macos-arm64-unsigned.dmg`를 내려받습니다. 현재 DMG는 Apple Developer
...
결과는 `.build/release/Solnari-0.5.2-macos-arm64-unsigned.dmg`와 SHA-256 파일입니다. 이 DMG는
...
결과는 `.build/release/Solnari-0.5.2-macos-arm64.dmg`와 SHA-256 파일입니다. 앱과 DMG를
